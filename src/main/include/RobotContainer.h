...
class RobotContainer {
 ...
 private:
  ...
  // just a fancy ramper
  frc::SlewRateLimiter<units::scalar> xLimiter{1 / 2_s, -3 / 1_s};
  frc::SlewRateLimiter<units::scalar> yLimiter{1 / 2_s, -3 / 1_s};
  frc::SlewRateLimiter<units::scalar> thetaLimiter{1 / 4_s, -10 / 1_s};
